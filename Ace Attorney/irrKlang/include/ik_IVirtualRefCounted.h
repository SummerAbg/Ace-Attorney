...
namespace irrklang {
//! Reference counting base class for objects in the Irrlicht Engine similar to
//! IRefCounted.
/** See IRefCounted for the basics of this class.
The difference to IRefCounted is that the class has to implement reference
counting for itself.
*/
...
public:
  ...
  implement this, use the class IRefCounted instead. See IRefCounted::grab() for
